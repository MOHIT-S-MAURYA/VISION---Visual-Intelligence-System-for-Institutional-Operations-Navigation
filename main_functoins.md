...
## 🔑 ID Generation Strategy (Automatic & Consistent)
...
1. **Student.face_embedding_id** - AI service generated
   ...
   - Flow:
     1. Student created in Django → `student.id` auto-generated
...
✅ **Primary Keys**: All auto-generated, no conflicts possible  
✅ **FAISS Index**: Uses `str(student.id)` - guaranteed unique  
✅ **Roll Numbers**: Validated unique at database level  
✅ **Employee IDs**: Validated unique at database level (if provided)  
✅ **Department Codes**: Validated unique at database level
